        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-12 px-0 ml-auto col-md-5 hero-img ">
              <img
                src="<?php bloginfo('template_directory');?>/images/girl+door-min.png"
                class="img-fluid d-none d-md-block"
                alt=""
              />
              <img
                src="<?php bloginfo('template_directory');?>/images/girl+door-mobile-min.png"
                class="img-fluid mobile-img d-md-none"
                alt=""
              />
            </div>
            <div class="col-md-12 px-md-0">
              <div class="gears rounded-lg">
                <div
                  class="row mx-2 py-3  py-md-5 hero-card align-items-center rounded-lg "
                >
                  <div class="col-12 text-center col-md-2 ">
                    <img
                      src="<?php bloginfo('template_directory');?>/images/icon-gears.svg"
                      class=" img-responsive d-none d-md-block mx-auto"
...
и агентам увеличить прибыль, избавиться от нежелательных гостей и защитить имущество. 
      ...
      <section class="container block ">
        <div class="cards cards-slider ">
            ...
            <div class="row mx-2 mx-md-auto p-1 align-items-center mb-md-5">
              <div class="col-md-6 my-4">
                <img
                  ...
                  src="<?php bloginfo('template_directory');?>/images/illustration-1.svg"
                  alt=""
                />
              </div>
              <div class="col-md-6">
          ...
          <div>
            <div
              class="row mx-2 mx-md-auto p-1 align-items-center mb-md-5 flex-wrap-reverse"
            >
              <div class="col-md-6 my-4">
                <h4 class="title-2 mb-4 text-primary text-center text-md-left">
                  Безопасная сделка
              ...
              <div class="col-md-6">
                <img
                  class="img-fluid illustration"
                  src="<?php bloginfo('template_directory');?>/images/illustration-2.svg"
                  alt=""
                />
              </div>
            </div>
          ...
          <div>
            <div class="row mx-2 mx-md-auto p-1 align-items-center mb-md-5">
              <div class="col-md-6 my-4">
                <img
                  class="img-fluid illustration"
                  src="<?php bloginfo('template_directory');?>/images/illustration-3.svg"
                  alt=""
                />
              </div>
              <div class="col-md-6">
                ...
                <p class="text-center text-md-left">
                  Датчики открытия двери и счетчик посещения подскажут по sms
                  сколько гостей в вашей квартире. Опишите инструкцию чем и как
                  пользоваться для самостоятельной ориентации гостя.
                </p>
              </div>
            </div>
          </div>
          <div>
            ...
            >
              ...
              <div class="col-md-6">
                <img
                  class="img-fluid illustration"
                  src="<?php bloginfo('template_directory');?>/images/illustration-4.svg"
                  alt=""
                />
              </div>
            </div>
          ...
          <div>
            <div class="row mx-2 mx-md-auto p-1 align-items-center mb-md-5">
              <div class="col-md-6 my-4">
                <img
                  class="img-fluid illustration"
                  src="<?php bloginfo('template_directory');?>/images/illustration-5.svg"
                  alt=""
                />
              </div>
              <div class="col-md-6">
      ...
      <div class="container block">
        <section class="block">
          ...
          <div class="row  flex-wrap-reverse">
            <div class="col-md-8  mt-4 mt-md-5">
              ...
              <button
                class="btn btn-light btn-lg mb-3"
                type="button"
        ...
        <section
          class=" block remote-card p-2 p-md-5 d-flex flex-column rounded-lg"
        >
        ...
        <section class="testimonials block">
          <div class="testimonials-container">
            ...
            <p class="arrows d-none d-lg-block">
              <img
                src="<?php bloginfo('template_directory');?>/images/arrow-l.svg"
                alt="arrow prev"
                class="prevto arrow mr-2"
              />
              <img
                src="<?php bloginfo('template_directory');?>/images/arrow-r.svg"
                alt="arrow next"
                class="nexto arrow"
              />
            </p>
                ...
                <div class="row  flex-wrap-reverse">
                  ...
                  <div class="col-md-6 offset-md-1">
                    <div class="iframe-container">
                      <iframe
                        src="https://www.youtube.com/embed/2ZlopCDt6iU"
                        frameborder="0"
            ...
            <div class="row app-preview iphone-slider">
              ...
              <div class="col-md-3 col-10">
                <img
                  ...
                  src="<?php bloginfo('template_directory');?>/images/iphone-3.png"
                  alt=""
                />
              </div>
            </div>
                ...
                <div class="m-3">
                  ...
                  <ul class="pricing-list mx-auto font-weight-bold">
                    ...
                    <li>
                      ...
                      <small
                        >(За каждое успешное заселение гостя удаленно)</small
                      >
                    </li>
                  </ul>
                </div>
        ...
        <section class="form-section container">
          <div class="row">
            <div
              class="  col-md-6 col-lg-4 offset-md-1 bg-white p-3 my-3 my-md-5 rounded-lg"
            >
